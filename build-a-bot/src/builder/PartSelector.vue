...
export default {
  props: { //   Props are the means by which you pass data from one component to another.
    parts: { // This validates that that the type is an array and throws an error if nothing is sent
      type: Array,
      required: true,
    },
    position: {
